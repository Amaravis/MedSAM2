...
def parse_args():
    ...
    parser.add_argument("--gt_dir", type=str, default="/scratch/svaidy33/cmbproj/SWI_dataset/new_vol_mask", help="test dir")
    parser.add_argument("--root", type=str, default="/scratch/svaidy33/CMB_detection/YOLO_data/images/swi_test/", help="test dir")
    return parser.parse_args()

def main(args):
    MASK_DIR = os.path.join(args.root)
    total_dice_score = 0
    count = 0
